        ...
        <div className="font-sans text-gray-900 leading-normal tracking-wider bg-cover">
            ...
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div id="profile"
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div
                            ...
                            style={{backgroundImage: `url(${MyPhoto})`}}></div>


                        <h1 className="text-3xl font-bold pt-8 lg:pt-0">Luiza Dumitriu Cristu</h1>
                        ...
                        <p className="pt-8 text-sm">Fie că te confrunți cu anxietate, depresie sau doar ai nevoie de
                            cineva cu care să vorbești, sunt aici pentru a te ajuta să navighezi prin provocările
                            vieții.</p>
                ...
                <div className="w-full lg:w-2/5">
                    {/* Big profile image for side bar (smaller) */}
                    <img src={MyPhoto} alt="Therapist photo" className="rounded-none lg:rounded-lg shadow-4xl hidden lg:block"/>
                 </div>
